...
const Boutique = (props) =>{
    return(
      ...
      <div className='w3-display-container w3-text-white'>
          ...
          <div className='w3-xxxlarge w3-display-middle w3-padding w3-text-black'><span className='w3-s-cap w3-text-black'>beauty boutique</span>
              <div className='w3-row w3-text-white'>
                  <div className='w3-third w3-center'>
                      <h3 className='w3-dark-grey w3-s-cap w3-button w3-round-xxlarge w3-padding-large'>Salon</h3>
                  </div>
                  <div className='w3-third w3-center'>
                      <h3 className='w3-dark-grey w3-s-cap w3-button w3-round-xxlarge w3-padding-large'>Spa</h3>
                  </div>
                  <div className='w3-third w3-center w3-margin-bottom'>
                      <h3 className='w3-dark-grey w3-s-cap w3-button w3-round-xxlarge w3-padding-large'>Apparel</h3>
                  </div>
              </div>
          </div>
      </div>
