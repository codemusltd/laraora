...
export const Subscribe = (props) =>{
    return(
        <div id='six' className='w3-container w3-center w3-padding'>
            <p className='w3-padding w3-text-grey'>SUBSCRIBE</p>
            <p className='w3-padding'>Sign up with your email address to receive news and updates.</p>
            <form className='w3-container w3-bar'>
                ...
                <input className='w3-button w3-bar-item w3-grey' type='button' value='SIGN UP'/>
            </form>
        </div>  
    )
  }
